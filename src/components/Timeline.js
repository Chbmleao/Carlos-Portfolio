    ...
    <div className="timeline" id="timeline">
      ...
      <div className="timeline-component timeline-component-bg">
        ...
        <p className="timeline-paragraph">
          ...
          de Belo Horizonte. Durante o desenvolvimento, realizamos pesquisas de
          campo e monitorias com especialistas da área.
        </p>
      </div>
      ...
      <div className="timeline-component timeline-component-bg">
        ...
        <p className="timeline-paragraph">
          ...
          houve uma competição dos melhores sites desenvolvidos, em que alcancei
          a fase estadual.
        </p>
      </div>
      <div className="timeline-middle">
      ...
      <div className="timeline-component timeline-component-bg">
        ...
        <p className="timeline-paragraph">
          ...
          Universidade Federal de Minas Gerais (UFMG). Desde o primeiro semestre
          me apaixonei pela universidade e pela área de computação. Atualmente
          estou cursando o sexto período.
        </p>
      </div>
      <div className="timeline-middle">
        <div className="timeline-point"></div>
      ...
      <div className="timeline-component">
        <div className="timeline-date timeline-date-left">17 de Maio, 2021</div>
      </div>
      ...
      <div className="timeline-component timeline-component-bg">
        ...
        <p className="timeline-paragraph">
          ...
          PostgreSQL. Desenvolvimento de funções de acesso e consulta aos dados
          de identificação textual de lugares, usando endereços e nomes
          catalogados. Utilização de Python e JavaScript para a estruturação da
          API para a consulta de endereços.
        </p>
      </div>

      <div className="timeline-component timeline-component-bottom timeline-component-bg">
        <h2 className="timeline-title">Acad Game 💪</h2>
        <p className="timeline-paragraph">
          Em 2022 participei do desenvolvimento do software Acad Game. Acad game
          é uma plataforma gameficada que visa engajar mais ao processo de
          frequentar e evoluir na academia. Tive a oportunidade de participar
          desde a idealização do projeto até seu desenvolvimento e realização de
          testes, em que me envolvi, principalmente, com o back-end em
          JavaScript e banco de dados em MySQL. Esse software é melhor explicado
      ...
      <div className="timeline-component timeline-component-bottom">
        <div className="timeline-date timeline-date-left">
          20 de Outubro, 2022
        </div>
      </div>
